...
import { Calendar, Bell, Download, Clock, AlertTriangle, CheckCircle2, FileText, Globe, Building, Plus, Filter, Lightbulb, X, ExternalLink, Send, Wallet } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1">
            <Card className="enterprise-card mb-6">
              ...
              <CardContent className="mx-0 px-0">
                <div className="w-full overflow-hidden mx-0 py-0 my-0 px-[16px]">
                  <CalendarComponent mode="single" selected={selectedDate} onSelect={setSelectedDate} className="rounded-md border pointer-events-auto w-full py-0 my-[6px] px-0 mx-0" />
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Select value={selectedJurisdiction} onValueChange={setSelectedJurisdiction}>
                    ...
                    <SelectContent>
                      ...
                      {jurisdictions.map(jurisdiction => <SelectItem key={jurisdiction.value} value={jurisdiction.value}>
                ...
                <div>
                  ...
                  <Select value={entityType} onValueChange={setEntityType}>
                    ...
                    <SelectContent>
                      {entityTypes.map(entity => <SelectItem key={entity.value} value={entity.value}>
                          {entity.label}
                        </SelectItem>)}
                    </SelectContent>
                  </Select>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="enterprise-card">
              ...
              <CardContent>
                <div className="space-y-4">
                  {upcomingFilings.map(filing => <div key={filing.id} className="p-4 border rounded-lg">
            ...
            <Card className="enterprise-card">
              ...
              <CardContent>
                <div className="space-y-3">
                  {completedFilings.map(filing => <div key={filing.id} className="flex items-center justify-between p-3 border rounded-lg">
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input id="deadline-title" placeholder="e.g., Quarterly Tax Filing" className="mt-1" />
            </div>
            
            <div>
              <Label htmlFor="deadline-date">Due Date</Label>
              <Input id="deadline-date" type="date" className="mt-1" />
            </div>
            ...
            <div>
              ...
              <Textarea id="deadline-notes" placeholder="Additional notes or requirements..." className="mt-1" />
            </div>
